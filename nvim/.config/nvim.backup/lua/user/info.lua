...
local function make_formatters_info(ft)
  local null_formatters = require "user.lsp.null-ls.formatters"
...
local function make_code_actions_info(ft)
  local null_actions = require "user.lsp.null-ls.code_actions"
...
local function make_linters_info(ft)
  local null_linters = require "user.lsp.null-ls.linters"
...
function M.toggle_popup(ft)
  ...
  local function set_syntax_hl()
    ...
    tbl_set_highlight(require("user.lsp.null-ls.formatters").list_registered(ft), "LvimInfoIdentifier")
    tbl_set_highlight(require("user.lsp.null-ls.linters").list_registered(ft), "LvimInfoIdentifier")
    tbl_set_highlight(require("user.lsp.null-ls.code_actions").list_registered(ft), "LvimInfoIdentifier")
  end

  local Popup = require("user.interface.popup"):new {
